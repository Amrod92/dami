  ...
  return (
    <div>
      <div className="relative">
        <section className="pb-6 pt-12 lg:pb-16 lg:pt-16">
          <div className="mx-auto max-w-7xl px-4 xl:px-0">
            <div className="flex flex-col items-start md:px-4 lg:items-start lg:px-8">
              <div className="mt-8 bg-gradient-to-b from-primary to-primary/70 bg-clip-text text-3xl font-semibold text-transparent sm:w-2/3 md:w-1/2 lg:mt-9 lg:text-4xl lg:leading-tight xl:w-2/3">
                Generate Dummy Data
              </div>
              <p className="mt-4 text-sm font-medium leading-normal text-muted-foreground lg:text-base sm:w-2/3 md:w-1/2 xl:w-2/5">
            ...
            <div className="mt-4 border-b border-border/60 lg:mt-6"></div>
            <div className="mt-6 space-y-0.5 md:px-4 lg:mt-9 lg:px-8">
              <details className="group open:bg-card/80 divide-y divide-border/60 focus:shadow-[0_0px_2px_0px_rgba(0,0,0,0.10)] open:mt-3 open:rounded-2xl hover:rounded-2xl">
                <summary className="group/question flex cursor-pointer hover:opacity-90 transition-all items-center justify-between gap-x-4 rounded-t-2xl p-4">
                  <div className="font-semibold text-foreground md:text-lg xl:text-xl">
                    How does the AI know what to generate?
                  </div>
                  <figure className="hidden shrink-0 items-center gap-x-3 whitespace-nowrap rounded-full bg-secondary/70 py-1.5 pl-3 pr-1.5 text-sm text-muted-foreground transition-all group-open:flex">
                    Collapse
                    <svg
                  ...
                  <figure className="flex shrink-0 items-center justify-center transition-all rounded-full bg-secondary/70 p-1.5 shadow-[0_2px_10px_0px_rgba(0,0,0,0.05)] group-open:hidden">
                    <svg
                      className="h-5 text-muted-foreground"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
